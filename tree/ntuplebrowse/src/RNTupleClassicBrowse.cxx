...
public:
   RVisualizationBrowsable(const ROOT::RNTuple& ntuple) : fInspector(ROOT::Experimental::RNTupleInspector::Create(ntuple))
   {}
   void Browse(TBrowser *b) final
   {
      if (!b || !gPad)
...
void ROOT::Internal::BrowseRNTuple(const void *ntuple, TBrowser *b)
{
   ...
   b->Add(new RVisualizationBrowsable(*static_cast<const ROOT::RNTuple *>(ntuple)));
